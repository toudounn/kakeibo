...
export const Header = () => {
    ...
    <Fab component={Link} to="monthly-category-total" variant="extended" size="small" color="primary">費目合計</Fab>
    <Fab component={Link} to="monthly-yearly-total" variant="extended" size="small" color="primary">月合計</Fab>
